...
class ChatRepository: ObservableObject {
    ...
    init(sessionRepository: ChatSessionRepository = ChatSessionRepository(),
    ...
    func addMessage(content: String, isUserMessage: Bool, to session: ChatSessionModel) -> MessageModel {
