...
final class NetworkErrorTests {
    ...
    @Test func testLocalizedDescription() {
        ...
        let underlyingError = NSError(domain: "test", code: 123, userInfo: [NSLocalizedDescriptionKey: "Network connection lost"])
        ...
        let decodingError = NSError(domain: "DecodingErrorDomain", code: 4, userInfo: [NSLocalizedDescriptionKey: "Key not found"])
    ...
    func testEquatableConformance() {
        ...
        let underlyingError1 = NSError(domain: "test", code: 123, userInfo: [NSLocalizedDescriptionKey: "Error message"])
        let underlyingError2 = NSError(domain: "test", code: 123, userInfo: [NSLocalizedDescriptionKey: "Error message"])
